describe('Sample Report - Download Stored Reports for CL Type', () => {
 ...
 // Row Per Page = 25
             // Set row per page in replace value in 25 

                // it('Sets row per page to 25', () => {
                //       // Wait for pagination to load
                //       cy.wait(5000);
  ...
  cy.get(':nth-child(2) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(3) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(4) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(5) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(6) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(7) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(8) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(9) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(10) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(11) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(12) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(13) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(14) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
  cy.get(':nth-child(15) > :nth-child(11) > .text-blue-500 > .ri-download-2-line').click();
