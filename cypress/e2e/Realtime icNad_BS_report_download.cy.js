describe('Sample Report - Download Stored Reports for BS Type', () => {
  ...
  it('Filters CL samples and downloads stored reports for 15 samples', () => {
    // Step 1: Open sample type dropdown and select 'BS'
    ...
    // cy.contains('Download started').should('be.visible');
        ...
        cy.get(':nth-child(1) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(2) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(3) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(4) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(5) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(6) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(7) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(8) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(9) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(10) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(11) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(12) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(13) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(14) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
        cy.get(':nth-child(15) > :nth-child(12) > .text-blue-500 > .ri-download-2-line').click();
